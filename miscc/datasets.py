...
class TextDataset(data.Dataset):
    ...
    def load_bbox(self):
        ...
        print('BBox: Total filenames: ', len(filenames), filenames[0])
        #
    ...
    def load_embedding(self, data_dir, embedding_type):
	    ...
	    #embedding_filename = '/char-CNN-RNN-embeddings2.pickle'
	    embedding_filename = '/VA_sounds.pickle'
	...
	filepath = os.path.join(data_dir, 'VA_img.pickle')
